...
> If you face any issue regarding the installation feel free to onen [open a new issue](https://github.com/mukira/CombatCovid19KE/issues)
...
We use GitHub Issues as the official bug tracker for **CombatCovid19KE**. Please Search [existing issues](https://github.com/mukira/CombatCovid19KE/issues). It’s possible someone has already reported the same problem.
If your problem or idea is not addressed yet, [open a new issue](https://github.com/mukira/CombatCovid19KE/issues/new)
